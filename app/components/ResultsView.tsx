  ...
  return (
    <div className="min-h-screen px-4 py-8">
      <div className="w-full max-w-4xl mx-auto space-y-8">
        {/* Score Summary */}
        <div className="bg-white/50 backdrop-blur-sm rounded-lg shadow-lg p-8 text-center space-y-4" role="region" aria-label="Quiz results summary">
        ...
        <div className="space-y-4" role="region" aria-label="Answer review">
          ...
          {results.questions.map((q, index) => {
            ...
            return (
              <article
                key={index}
                className={`bg-white/50 backdrop-blur-sm rounded-lg shadow-md p-6 space-y-3 border-l-4 ${
